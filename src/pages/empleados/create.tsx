...
export const EmpleadosCreate = () => {
  ...
  // Stepper activo según scroll
  const [activeStep, setActiveStep] = useState(0);
  useEffect(() => {
    const sections = [
      document.getElementById("seccion-identificacion"),
      document.getElementById("seccion-contacto"),
      document.getElementById("seccion-laboral"),
    ];
    const onScroll = () => {
      ...
      for (let i = 0; i < sections.length; i++) {
        if (sections[i]) {
          const top =
            sections[i]!.getBoundingClientRect().top + window.scrollY - 100; // margen visual
      ...
      <div className="relative w-full max-w-5xl p-0 sm:p-4 md:p-8 bg-white/90 rounded-3xl shadow-2xl border border-slate-200 flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row w-full">
          ...
          >
            ...
            <section id="seccion-identificacion" className="mb-6 scroll-mt-32">
